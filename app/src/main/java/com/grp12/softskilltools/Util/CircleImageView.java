...
public class CircleImageView extends ImageView {
    ...
    public void setmArcWidth(float mArcWidth) {
    ...
    public RectF getmBorderRect() {
        return mBorderRect;
    }

    public final RectF mBorderRect = new RectF();

    public RectF getmArcRect() {
        return mArcRect;
    }
    ...
    private void setup() {
        ...
        mArcRect.set(0 + mArcWidth, 0 + mArcWidth, getWidth() - mArcWidth, getHeight() - mArcWidth);
        mBorderRadius = Math.min((mBorderRect.height() - (mBorderWidth)) / 2.0f, (mBorderRect.width() - (mBorderWidth)) / 2.0f);

        //  mBorderRadius = Math.min((mBorderRect.height() - mBorderWidth) / 2.0f, (mBorderRect.width() - mBorderWidth) / 2.0f);

        mDrawableRect.set(mArcRect);
        // mDrawableRect.inset(mArcWidth,mArcWidth);
        // mDrawableRect.set(mArcRect);
